          ...
          <div>
            ...
            <div class="relative">
              ...
              <input [(ngModel)]="newMatch.date" name="date" type="date" required
                     class="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-accent-light dark:focus:ring-accent-dark outline-none transition-all">
            </div>
          </div>
          <div>
